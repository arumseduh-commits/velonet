    ...
    <aside className="w-64 bg-white border-r border-slate-200 shadow-xs flex flex-col justify-between h-full sticky top-0 z-30 overflow-y-auto">
      ...
      <div className="p-3 border-t border-slate-200 space-y-2">
        <Link
          href="/"
          target="_blank"
          className="flex items-center justify-between p-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-xs font-semibold text-slate-700 btn-press transition-colors"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-2.5 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-xs font-semibold text-rose-700 btn-press transition-colors cursor-pointer"
        >
          <span className="flex items-center gap-2">
