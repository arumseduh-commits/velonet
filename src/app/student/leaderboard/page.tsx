...
export default function LeaderboardPage() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-6 pb-24 md:pb-12 space-y-6 text-slate-900">
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-6 rounded-3xl bg-gradient-to-r from-amber-50 via-orange-50/40 to-white border border-amber-200/80 shadow-xs text-slate-900">
        <div className="flex items-center gap-3.5">
          <Link
            href="/student"
            className="p-2.5 rounded-2xl bg-white hover:bg-slate-100 text-slate-700 transition-colors border border-slate-200 shadow-xs btn-press cursor-pointer"
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 mt-0.5">
              Peringkat keaktifan siswa berdasarkan perolehan XP kehadiran dan pembelajaran
            </p>
          </div>
        </div>
        ...
        <div className="flex bg-slate-100 p-1.5 rounded-2xl border border-slate-200 self-start sm:self-auto">
          <button
            ...
            className={`px-4 py-2 text-xs font-bold rounded-xl btn-press transition-all cursor-pointer ${
              activeTab === "global"
